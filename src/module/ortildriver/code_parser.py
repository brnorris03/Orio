...
def p_assignment_expression_2(p):
    ...
    if (p[2] == '='):
        ...
        if (p[2] == '*='):
            ...
            print 'internal error:OrTilDriver: unknown assignment operator'
            sys.exit(1)
...
def p_equality_expression_2(p):
    ...
    if p[2] == '==':
        ...
        print 'internal error:OrTilDriver: unknown equality operator'
        sys.exit(1)
...
def p_relational_expression_2(p):
    ...
    if (p[2] == '<'):
        ...
        print 'internal error:OrTilDriver: unknown relational operator'
        sys.exit(1)
...
def p_additive_expression_2(p):
    ...
    if (p[2] == '+'):
        ...
        print 'internal error:OrTilDriver: unknown additive operator' 
        sys.exit(1)
...
def p_multiplicative_expression_2(p):
    ...
    if (p[2] == '*'):
        ...
        print 'internal error:OrTilDriver: unknown multiplicative operator'
        sys.exit(1)
...
def p_unary_expression_4(p):
    ...
    if p[1] == '+':
        ...
        print 'internal error:OrTilDriver: unknown unary operator'
        sys.exit(1)
