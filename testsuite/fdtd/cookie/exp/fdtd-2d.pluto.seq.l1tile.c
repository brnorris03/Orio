...
for (c1=0;c1<=floord(tmax-1,32);c1++) {
  for (c2=max(0,ceild(32*c1-31,32));c2<=min(floord(tmax+ny-1,32),floord(32*c1+ny+31,32));c2++) {
    for (c3=max(max(max(max(max(max(max(max(max(max(ceild(32*c1-31*ny-899,992),ceild(32*c2-ny-30,32)),ceild(64*c1-32*c2-61,32)),ceild(32*c1-31,32)),ceild(32*c1-ny-29,32)),0),ceild(992*c1-960*c2-30*nx-ny-899,32)),ceild(32*c1-992*c2-1891,992)),ceild(1024*c1-992*c2-30*nx-931,32)),ceild(32*c1-992*c2-30*nx-931,32)),ceild(32*c1-960*c2-30*nx-ny-899,32));c3<=min(min(min(floord(32*c2+nx+30,32),floord(tmax+nx-1,32)),floord(32*c1+nx+31,32)),c1+32*c2+nx+30);c3++) {
      ...
      if ((c1 <= floord(32*c2-ny,32)) && (c2 >= max(ceild(ny,32),ceild(32*c3-nx+ny+1,32)))) {
      ...
      for (c4=max(max(max(0,32*c3-nx+1),32*c2-ny+1),32*c1);c4<=min(min(min(min(min(32*c2-1,32*c3-nx+31),32*c3-1),tmax-1),32*c1+31),32*c2-ny+31);c4++) {
        for (c5=32*c2;c5<=c4+ny-1;c5++) {
      ...
      if (ny >= 2) {
        for (c4=max(max(max(32*c2,0),32*c3-nx+1),32*c1);c4<=min(min(min(min(32*c3-nx+31,32*c3-1),tmax-1),32*c1+31),32*c2-ny+31);c4++) {
          for (c6=32*c3;c6<=c4+nx-1;c6++) {
            {ey[-c4+c6][0]=ey[-c4+c6][0]-((double)(1))/2*(hz[-c4+c6][0]-hz[-c4+c6-1][0]);} ;
          }
          for (c5=c4+1;c5<=c4+ny-1;c5++) {
      ...
      for (c4=max(max(max(0,32*c1),32*c3-nx+1),32*c2-ny+32);c4<=min(min(min(min(tmax-1,32*c3-1),32*c1+31),32*c2-1),32*c3-nx+31);c4++) {
        for (c5=32*c2;c5<=32*c2+31;c5++) {
          for (c6=32*c3;c6<=c4+nx-1;c6++) {
            {ey[-c4+c6][-c4+c5]=ey[-c4+c6][-c4+c5]-((double)(1))/2*(hz[-c4+c6][-c4+c5]-hz[-c4+c6-1][-c4+c5]);} ;
            {ex[-c4+c6][-c4+c5]=ex[-c4+c6][-c4+c5]-((double)(1))/2*(hz[-c4+c6][-c4+c5]-hz[-c4+c6][-c4+c5-1]);} ;
      ...
      for (c4=max(max(max(32*c3-nx+32,0),32*c2-ny+1),32*c1);c4<=min(min(min(min(32*c2-1,32*c3-1),tmax-1),32*c1+31),32*c2-ny+31);c4++) {
        for (c5=32*c2;c5<=c4+ny-1;c5++) {
      ...
      for (c4=max(max(max(max(32*c2,0),32*c1),32*c3-nx+1),32*c2-ny+32);c4<=min(min(min(min(tmax-1,32*c3-1),32*c2+30),32*c1+31),32*c3-nx+31);c4++) {
        for (c6=32*c3;c6<=c4+nx-1;c6++) {
          {ey[-c4+c6][0]=ey[-c4+c6][0]-((double)(1))/2*(hz[-c4+c6][0]-hz[-c4+c6-1][0]);} ;
        }
        for (c5=c4+1;c5<=32*c2+31;c5++) {
      ...
      if (ny >= 2) {
        for (c4=max(max(max(32*c2,32*c3-nx+32),0),32*c1);c4<=min(min(min(32*c3-1,tmax-1),32*c1+31),32*c2-ny+31);c4++) {
          for (c6=32*c3;c6<=32*c3+31;c6++) {
            {ey[-c4+c6][0]=ey[-c4+c6][0]-((double)(1))/2*(hz[-c4+c6][0]-hz[-c4+c6-1][0]);} ;
          }
          for (c5=c4+1;c5<=c4+ny-1;c5++) {
      ...
      for (c4=max(max(max(0,32*c1),32*c3-nx+32),32*c2-ny+32);c4<=min(min(min(tmax-1,32*c3-1),32*c1+31),32*c2-1);c4++) {
...
/*@ end @*/
      ...
      for (c4=max(max(max(max(32*c2,32*c3-nx+32),0),32*c1),32*c2-ny+32);c4<=min(min(min(tmax-1,32*c3-1),32*c1+31),32*c2+30);c4++) {
        for (c6=32*c3;c6<=32*c3+31;c6++) {
          {ey[-c4+c6][0]=ey[-c4+c6][0]-((double)(1))/2*(hz[-c4+c6][0]-hz[-c4+c6-1][0]);} ;
        }
        for (c5=c4+1;c5<=32*c2+31;c5++) {
      ...
      if (ny == 1) {
        for (c4=max(max(max(0,32*c3-nx+1),32*c1),32*c2);c4<=min(min(min(32*c3-1,tmax-1),32*c1+31),32*c2+30);c4++) {
      ...
      if ((c1 == c3) && (c2 <= min(floord(32*c3-1,32),floord(tmax-32,32))) && (nx >= 2) && (ny == 1)) {
        {ey[0][0]=32*c2+31;} ;
        for (c6=32*c2+32;c6<=min(32*c2+nx+30,32*c3+31);c6++) {
          {ey[-32*c2+c6-31][0]=ey[-32*c2+c6-31][0]-((double)(1))/2*(hz[-32*c2+c6-31][0]-hz[-32*c2+c6-31 -1][0]);} ;
        }
      }
      if ((c1 == c3) && (c2 <= min(floord(32*c3-1,32),floord(tmax-32,32))) && (nx >= 2) && (ny >= 2)) {
        {ey[0][0]=32*c2+31;} ;
        for (c6=32*c2+32;c6<=min(32*c2+nx+30,32*c3+31);c6++) {
          {ey[-32*c2+c6-31][0]=ey[-32*c2+c6-31][0]-((double)(1))/2*(hz[-32*c2+c6-31][0]-hz[-32*c2+c6-31 -1][0]);} ;
        }
      }
      if ((-c1 == -c3) && (c1 >= ceild(32*c2-31,32)) && (c1 <= min(floord(tmax-32,32),floord(32*c2-1,32))) && (nx == 1) && (ny >= 2)) {
        {ey[0][0]=32*c1+31;} ;
        for (c5=32*c1+32;c5<=min(32*c2+31,32*c1+ny+30);c5++) {
          {ey[0][-32*c1+c5-31]=32*c1+31;} ;
          {ex[0][-32*c1+c5-31]=ex[0][-32*c1+c5-31]-((double)(1))/2*(hz[0][-32*c1+c5-31]-hz[0][-32*c1+c5-31 -1]);} ;
        }
      }
      if ((-c1 == -c3) && (c1 <= min(floord(tmax-32,32),c2-1)) && (nx == 1)) {
        for (c5=32*c2;c5<=min(32*c2+31,32*c1+ny+30);c5++) {
          {ey[0][-32*c1+c5-31]=32*c1+31;} ;
          {ex[0][-32*c1+c5-31]=ex[0][-32*c1+c5-31]-((double)(1))/2*(hz[0][-32*c1+c5-31]-hz[0][-32*c1+c5-31 -1]);} ;
        }
      }
      if ((c1 == c3) && (c2 <= min(floord(tmax-32,32),c3)) && (nx == 1) && (ny == 1)) {
        {ey[0][0]=32*c2+31;} ;
      }
      if ((-c1 == -c3) && (c1 <= min(floord(tmax-32,32),floord(32*c2-1,32))) && (nx == 1) && (ny == 1)) {
        {ey[0][0]=32*c1+31;} ;
      }
      if ((c1 == c3) && (c2 <= min(floord(tmax-32,32),c3)) && (nx == 1) && (ny >= 2)) {
        {ey[0][0]=32*c2+31;} ;
      }
      if ((-c1 == -c3) && (c1 >= ceild(32*c2-31,32)) && (c1 <= min(floord(tmax-32,32),floord(32*c2-1,32))) && (nx >= 2) && (ny >= 2)) {
        {ey[0][0]=32*c1+31;} ;
        for (c5=32*c1+32;c5<=min(32*c2+31,32*c1+ny+30);c5++) {
          {ey[0][-32*c1+c5-31]=32*c1+31;} ;
          {ex[0][-32*c1+c5-31]=ex[0][-32*c1+c5-31]-((double)(1))/2*(hz[0][-32*c1+c5-31]-hz[0][-32*c1+c5-31 -1]);} ;
      ...
      if ((-c1 == -c3) && (c1 <= min(floord(tmax-32,32),c2-1)) && (nx >= 2)) {
        for (c5=32*c2;c5<=min(32*c2+31,32*c1+ny+30);c5++) {
          {ey[0][-32*c1+c5-31]=32*c1+31;} ;
          {ex[0][-32*c1+c5-31]=ex[0][-32*c1+c5-31]-((double)(1))/2*(hz[0][-32*c1+c5-31]-hz[0][-32*c1+c5-31 -1]);} ;
        }
      }
      if ((-c1 == -c3) && (c1 <= min(floord(tmax-32,32),c2)) && (nx >= 2) && (ny == 1)) {
        {ey[0][0]=32*c1+31;} ;
      }
      if ((-c1 == -c2) && (-c1 == -c3) && (c1 <= floord(tmax-32,32)) && (nx >= 2) && (ny >= 2)) {
        {ey[0][0]=32*c1+31;} ;
      }
      if ((c1 >= c2) && (c2 <= min(floord(tmax-32,32),c3-1)) && (ny == 1)) {
        for (c6=32*c3;c6<=min(32*c2+nx+30,32*c3+31);c6++) {
          {ey[-32*c2+c6-31][0]=ey[-32*c2+c6-31][0]-((double)(1))/2*(hz[-32*c2+c6-31][0]-hz[-32*c2+c6-31 -1][0]);} ;
        }
      }
      if ((c1 >= c2) && (c2 <= min(floord(tmax-32,32),c3-1)) && (ny >= 2)) {
        for (c6=32*c3;c6<=min(32*c2+nx+30,32*c3+31);c6++) {
          {ey[-32*c2+c6-31][0]=ey[-32*c2+c6-31][0]-((double)(1))/2*(hz[-32*c2+c6-31][0]-hz[-32*c2+c6-31 -1][0]);} ;
        }
      }
