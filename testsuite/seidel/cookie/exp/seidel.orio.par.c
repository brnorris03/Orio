...
/* polysyn start */
if (N >= 3) {
  for (c1=-1;c1<=floord(5*T+4*N-13,32);c1++) {
 lb1=max(max(ceild(16*c1-3,20),0),ceild(32*c1-T+1,32));
 ub1=min(min(floord(32*c1+31,32),floord(T+N-3,8)),floord(32*c1+N+29,40));
...
permut = [['c7', 'c8', 'c9']],
  ...
  vector = (True, ['ivdep','vector always']))
      ...
      for (c3=max(max(max(max(ceild(4*c2-255,256),0),ceild(16*c1-12*c2-255,256)),ceild(16*c2-N-508,512)),ceild(64*c1-64*c2-509,512));c3<=min(min(min(min(floord(T+N-3,256),floord(32*c1-24*c2+N+36,512)),floord(8*c2+T+N+4,512)),floord(16*c2+N+11,512)),floord(32*c1-32*c2+N+29,256));c3++) {
        for (c7=max(max(max(max(0,32*c1-32*c2),8*c2-N+2),256*c3-N+2),-8*c2+512*c3-N-5);c7<=min(min(min(min(T-1,32*c1-32*c2+31),8*c2+6),floord(512*c3+509,2)),-8*c2+512*c3+510);c7++) {
  ...
  for (c3=max(max(max(max(ceild(4*c2-255,256),0),ceild(16*c1-12*c2-255,256)),ceild(16*c2-N-508,512)),ceild(64*c1-64*c2-509,512)); c3<=min(min(min(min(floord(T+N-3,256),floord(32*c1-24*c2+N+36,512)),floord(8*c2+T+N+4,512)),floord(16*c2+N+11,512)),floord(32*c1-32*c2+N+29,256)); c3++ ) {
    {
      for (c7=max(max(max(max(0,32*c1-32*c2),8*c2-N+2),256*c3-N+2),-8*c2+512*c3-N-5); c7<=min(min(min(min(T-1,32*c1-32*c2+31),8*c2+6),floord(512*c3+509,2)),-8*c2+512*c3+510)-2; c7=c7+3) {
        for (c8=max(max(8*c2,c7+1),512*c3-c7-N+2); c8<=min(min(8*c2+7,c7+N-2),512*c3-c7+510); c8++ ) {
          {
...
#pragma vector always
      ...
      for (; c7<=min(min(min(min(T-1,32*c1-32*c2+31),8*c2+6),floord(512*c3+509,2)),-8*c2+512*c3+510); c7=c7+1) {
        for (c8=max(max(8*c2,c7+1),512*c3-c7-N+2); c8<=min(min(8*c2+7,c7+N-2),512*c3-c7+510); c8++ ) {
          {
