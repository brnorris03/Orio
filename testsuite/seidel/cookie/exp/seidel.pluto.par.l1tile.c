...
#pragma omp parallel for shared(c1,lb1,ub1) private(c2,c3,c4,c5,c6)
 for (c2=lb1; c2<=ub1; c2++) {
      for (c3=max(max(max(max(0,ceild(16*c2-15,16)),ceild(64*c1-64*c2-29,32)),ceild(64*c2-N-28,32)),ceild(16*c1-15,16));c3<=min(min(min(min(floord(64*c2+N+59,32),floord(32*c2+T+N+28,32)),floord(32*c1+N+60,32)),floord(T+N-3,16)),floord(32*c1-32*c2+N+29,16));c3++) {
        for (c4=max(max(max(max(0,32*c2-N+2),32*c1-32*c2),-32*c2+32*c3-N-29),16*c3-N+2);c4<=min(min(min(min(T-1,32*c1-32*c2+31),floord(32*c3+29,2)),32*c2+30),-32*c2+32*c3+30);c4++) {

	  /*@ begin Loop(
	    transform Unroll(ufactor=4)
          for (c5=max(max(c4+1,32*c2),32*c3-c4-N+2);c5<=min(min(c4+N-2,32*c3-c4+30),32*c2+31);c5++) {
     ...
     for (c5=max(max(c4+1,32*c2),32*c3-c4-N+2); c5<=min(min(c4+N-2,32*c3-c4+30),32*c2+31)-3; c5=c5+4) {
       {
     ...
     for (; c5<=min(min(c4+N-2,32*c3-c4+30),32*c2+31); c5=c5+1) {
       {
         for (c6=max(c4+c5+1,32*c3); c6<=min(c4+c5+N-2,32*c3+31)-3; c6=c6+4) {
           A[-c4+c5][-c4+c6-c5]=0.111111111111*(A[-c4+c5+1][-c4+c6-c5+1]+A[-c4+c5+1][-c4+c6-c5]+A[-c4+c5+1][-c4+c6-c5-1]+A[-c4+c5][-c4+c6-c5+1]+A[-c4+c5][-c4+c6-c5]+A[-c4+c5][-c4+c6-c5-1]+A[-c4+c5-1][-c4+c6-c5+1]+A[-c4+c5-1][-c4+c6-c5]+A[-c4+c5-1][-c4+c6-c5-1]);
           A[-c4+c5][-c4+c6-c5+1]=0.111111111111*(A[-c4+c5+1][-c4+c6-c5+2]+A[-c4+c5+1][-c4+c6-c5+1]+A[-c4+c5+1][-c4+c6-c5]+A[-c4+c5][-c4+c6-c5+2]+A[-c4+c5][-c4+c6-c5+1]+A[-c4+c5][-c4+c6-c5]+A[-c4+c5-1][-c4+c6-c5+2]+A[-c4+c5-1][-c4+c6-c5+1]+A[-c4+c5-1][-c4+c6-c5]);
