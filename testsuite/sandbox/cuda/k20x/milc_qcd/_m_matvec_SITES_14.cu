__global__ void orcu_kernel125831(const int sites_on_node, double* A, double* y, double* x) {
...
Best performance cost: 
  [0.047808000000000003, 0.022976, 0.023231999999999999, 0.022880000000000001, 0.022880000000000001, 0.022943999999999999] 
...
--**/
  ...
  ) @*/
  {
    ...
    orcu_kernel125831<<<dimGrid,dimBlock>>>(sites_on_node,dev_A,dev_y,dev_x);
