__global__ void orcu_kernel71903(const int sites_on_node, double* A, double* y, double* x) {
...
Best performance cost: 
  [0.047168000000000002, 0.021984, 0.021888000000000001, 0.019775999999999998, 0.020767999999999998, 0.021568] 
...
--**/
  ...
  ) @*/
  {
    ...
    orcu_kernel71903<<<dimGrid,dimBlock>>>(sites_on_node,dev_A,dev_y,dev_x);
