__global__ void orcu_kernel107855(const int sites_on_node, double* A, double* y, double* x) {
...
Best performance cost: 
  [0.045823999999999997, 0.022752000000000001, 0.022336000000000002, 0.022048000000000002, 0.021440000000000001, 0.021856] 
...
--**/
  ...
  ) @*/
  {
    ...
    orcu_kernel107855<<<dimGrid,dimBlock>>>(sites_on_node,dev_A,dev_y,dev_x);
