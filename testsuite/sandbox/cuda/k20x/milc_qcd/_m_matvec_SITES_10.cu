__global__ void orcu_kernel89879(const int sites_on_node, double* A, double* y, double* x) {
...
Best performance cost: 
  [0.046016000000000001, 0.021024000000000001, 0.021600000000000001, 0.022464000000000001, 0.021248, 0.021440000000000001] 
...
--**/
  ...
  ) @*/
  {
    ...
    orcu_kernel89879<<<dimGrid,dimBlock>>>(sites_on_node,dev_A,dev_y,dev_x);
