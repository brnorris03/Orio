...
__global__ void orcu_kernel2(const int sites_on_node, double* A, double* y, double* x) {
...
int main(int argc, char *argv[]) {
  ...
  ) @*/
  {
    ...
    orcu_kernel2<<<dimGrid,dimBlock>>>(sites_on_node,dev_A,dev_y,dev_x);
