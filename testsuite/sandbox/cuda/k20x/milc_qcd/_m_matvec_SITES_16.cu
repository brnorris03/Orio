__global__ void orcu_kernel143807(const int sites_on_node, double* A, double* y, double* x) {
...
Best performance cost: 
  [0.050015999999999998, 0.024192000000000002, 0.024576000000000001, 0.024767999999999998, 0.024160000000000001, 0.023935999999999999] 
...
--**/
  ...
  ) @*/
  {
    ...
    orcu_kernel143807<<<dimGrid,dimBlock>>>(sites_on_node,dev_A,dev_y,dev_x);
