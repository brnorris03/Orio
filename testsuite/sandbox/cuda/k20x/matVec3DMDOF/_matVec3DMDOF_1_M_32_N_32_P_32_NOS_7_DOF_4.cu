__global__ void orcu_kernel8075(const int nrows, const int ndiags, int sbdiag, int ndofs, int* offsets, double* A, double* x, double* y) {
...
Best performance cost: 
  [0.244224, 0.22364800000000001, 0.22559999999999999, 0.22505600000000001, 0.22470399999999999] 
...
--**/
  ...
  ) @*/
  {
    ...
    orcu_kernel8075<<<dimGrid,dimBlock>>>(nrows,ndiags,sbdiag,ndofs,dev_offsets,dev_A,dev_x,dev_y);
