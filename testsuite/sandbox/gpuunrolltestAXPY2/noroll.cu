...
__global__ void orcu_kernel11(int n, int orcu_var8, double a1, double a2, double* y, double* x1, double* x2) {
...
{
  {
    int orio_lbound2=0;
    {
      ...
      HANDLE_ERROR(cudaMalloc((void**)&dev_x2,nbytes));
      ...
      HANDLE_ERROR(cudaMemcpy(dev_x2,x2,nbytes,cudaMemcpyHostToDevice));
      /*invoke device kernel*/
      int orcu_var8=orio_lbound2;
      HANDLE_ERROR(cudaEventRecord(start, 0));
      orcu_kernel11<<<dimGrid,dimBlock>>>(n,orcu_var8,a1,a2,dev_y,dev_x1,dev_x2);
