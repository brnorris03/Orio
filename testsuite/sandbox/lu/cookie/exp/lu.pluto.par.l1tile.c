...
if (N >= 2) {
 ...
 lb1=max(max(ceild(32*c1-N+2,32),ceild(16*c1-15,32)),0);
...
#pragma vector always
 for (c6=lbv; c6<=ubv; c6++) {
     ...
     {
  for (c4 = max(0, 32 * c1 - 32 * c2); c4 <= min(min(32 * c3 - 1, 32 * c1 - 32 * c2 + 31), 32 * c2 + 30) - 3; c4 = c4 + 4) {
...
#pragma vector always
 for (c6=lbv; c6<=ubv; c6++) {
  ...
  for (; c4 <= min(min(32 * c3 - 1, 32 * c1 - 32 * c2 + 31), 32 * c2 + 30); c4 = c4 + 1) {
      for (c5 = 32 * c3; c5 <= min(N - 1, 32 * c3 + 31) - 3; c5 = c5 + 4)
{
 lbv=max(32*c2,c4+1); ubv=min(N-1,32*c2+31);
#pragma ivdep
...
{
 lbv=max(32*c1-32*c2+32,32*c2); ubv=min(N-1,32*c2+31);
#pragma ivdep
#pragma vector always
 for (c6=lbv; c6<=ubv; c6++) {
            {A[32*c1-32*c2+31][c6]=A[32*c1-32*c2+31][c6]/A[32*c1-32*c2+31][32*c1-32*c2+31];} ;
          }
}
        }
      }
