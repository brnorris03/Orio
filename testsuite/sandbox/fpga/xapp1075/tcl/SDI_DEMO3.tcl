# 
# Project automation script for SDI_DEMO3
# 
# Created for ISE version 12.1
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source SDI_DEMO3.tcl), then you can
...
set myProject "SDI_DEMO3"
set myScript "SDI_DEMO3.tcl"
...
proc run_process {} {
   ...
   if { ! [ process run "Implement Design" -force rerun_all] } {
...
proc add_source_files {} {
   ...
   xfile add "../src/VHDL/V6_SDI/SMPTE352_vpid_capture.vhd"
   xfile add "../src/VHDL/V6_SDI/SMPTE352_vpid_insert.vhd"
   xfile add "../src/VHDL/V6_SDI/SMPTE425_B_demux2.vhd"
   xfile add "../src/VHDL/V6_SDI/anc_edh_pkg.vhd"
   xfile add "../src/VHDL/V6_SDI/anc_rx.vhd"
   xfile add "../src/VHDL/V6_SDI/autodetect.vhd"
   xfile add "../src/VHDL/V6_SDI/edh_crc.vhd"
   xfile add "../src/VHDL/V6_SDI/edh_crc16.vhd"
   xfile add "../src/VHDL/V6_SDI/edh_errcnt.vhd"
   xfile add "../src/VHDL/V6_SDI/edh_flags.vhd"
   xfile add "../src/VHDL/V6_SDI/edh_loc.vhd"
   xfile add "../src/VHDL/V6_SDI/edh_processor.vhd"
   xfile add "../src/VHDL/V6_SDI/edh_rx.vhd"
   xfile add "../src/VHDL/V6_SDI/edh_tx.vhd"
   xfile add "../src/VHDL/V6_SDI/fly_field.vhd"
   xfile add "../src/VHDL/V6_SDI/fly_fsm.vhd"
   xfile add "../src/VHDL/V6_SDI/fly_horz.vhd"
   xfile add "../src/VHDL/V6_SDI/fly_vert.vhd"
   xfile add "../src/VHDL/V6_SDI/flywheel.vhd"
   xfile add "../src/VHDL/V6_SDI/hdsdi_crc2.vhd"
   xfile add "../src/VHDL/V6_SDI/hdsdi_insert_crc.vhd"
   xfile add "../src/VHDL/V6_SDI/hdsdi_insert_ln.vhd"
   xfile add "../src/VHDL/V6_SDI/hdsdi_pkg.vhd"
   xfile add "../src/VHDL/V6_SDI/hdsdi_rx_crc.vhd"
   xfile add "../src/VHDL/V6_SDI/multi_sdi_decoder.vhd"
   xfile add "../src/VHDL/V6_SDI/multi_sdi_encoder.vhd"
   xfile add "../src/VHDL/V6_SDI/multi_sdi_framer.vhd"
   xfile add "../src/VHDL/V6_SDI/mux12_wide.vhd"
   xfile add "../src/VHDL/V6_SDI/sdi_bitrep_20b.vhd"
   xfile add "../src/VHDL/V6_SDI/smpte_encoder.vhd"
   xfile add "../src/VHDL/V6_SDI/triple_sdi_autodetect_ln.vhd"
   xfile add "../src/VHDL/V6_SDI/triple_sdi_rx_20b_v6gtx.vhd"
   xfile add "../src/VHDL/V6_SDI/triple_sdi_rx_autorate.vhd"
   xfile add "../src/VHDL/V6_SDI/triple_sdi_tx_output_20b.vhd"
   xfile add "../src/VHDL/V6_SDI/triple_sdi_vpid_insert.vhd"
   xfile add "../src/VHDL/V6_SDI/trs_detect.vhd"
   xfile add "../src/VHDL/V6_SDI/v6gtx_sdi_control.vhd"
   xfile add "../src/VHDL/V6_SDI/v6gtx_sdi_drp_control.vhd"
   xfile add "../src/VHDL/V6_SDI/v6gtx_sdi_rate_detect.vhd"
   xfile add "../src/VHDL/V6_SDI/v6sdi_wrapper.vhd"
   xfile add "../src/VHDL/V6_SDI/v6sdi_wrapper_gtx.vhd"
   xfile add "../src/VHDL/V6_SDI/video_decode.vhd"
   xfile add "../src/VHDL/V6_SDI/wide_SRLC16E.vhd"
   xfile add "../src/VHDL/dru/bshift10to10.vhd"
   xfile add "../src/VHDL/dru/control.vhd"
   xfile add "../src/VHDL/dru/maskencoder.vhd"
   xfile add "../src/VHDL/dru/rot20.vhd"
   xfile add "../src/VHDL/dru/dru.ngc"
   xfile add "../src/VHDL/main_demo/v6_sdi_rxtx.vhd"
   xfile add "../src/VHDL/main_demo/v6sdi_4rx4tx_demo.ucf"
   xfile add "../src/VHDL/main_demo/v6sdi_4rx4tx_demo.vhd"
   xfile add "../src/VHDL/misc_source/AVBCM.vhd"
   xfile add "../src/VHDL/misc_source/AVBSPI.vhd"
   xfile add "../src/VHDL/misc_source/LCDAUX3.vhd"
   xfile add "../src/VHDL/misc_source/LCDCTRL3.vhd"
   xfile add "../src/VHDL/misc_source/Si5324_fsel_lookup.vhd"
   xfile add "../src/VHDL/misc_source/cm_avb_control.vhd"
   xfile add "../src/VHDL/misc_source/kcpsm3.vhd"
   xfile add "../src/VHDL/misc_source/lcd_control3.vhd"
   xfile add "../src/VHDL/misc_source/main_avb_control.vhd"
   xfile add "../src/VHDL/video_gen/multigenHD.vhd"
   xfile add "../src/VHDL/video_gen/multigenHD_horz.vhd"
   xfile add "../src/VHDL/video_gen/multigenHD_output.vhd"
   xfile add "../src/VHDL/video_gen/multigenHD_pkg.vhd"
   xfile add "../src/VHDL/video_gen/multigenHD_vert.vhd"
   xfile add "../src/VHDL/video_gen/vidgen_ntsc.vhd"
   xfile add "../src/VHDL/video_gen/vidgen_pal.vhd"
   xfile add "../src/ipcore_dir/icon.xco"
#   xfile add "ipcore_dir/icon.xise"
   xfile add "../src/ipcore_dir/ila.xco"
#   xfile add "ipcore_dir/ila.xise"
   xfile add "../src/ipcore_dir/rx_vio.xco"
#   xfile add "ipcore_dir/rx_vio.xise"
   xfile add "../src/ipcore_dir/vio.xco"
#   xfile add "ipcore_dir/vio.xise"

   # Set the Top Module as well...
   project set top "xilinx" "v6sdi_4rx4tx_demo"
...
proc set_process_props {} {
   ...
   project set "Selected Module Instance Name" "/v6sdi_4rx4tx_demo"
...
#   project set "Optimization Goal" SpeedOrArea -process "Synthesize - XST"
...
#  project set "Working Directory" "."
   ...
   project set "Macro Search Path" "../src/" -process "Translate"
   ...
   project set "Output File Name" "v6sdi_4rx4tx_demo" -process "Generate IBIS Model"
