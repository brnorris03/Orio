...
runExp('base_seq', '-qsmp=noauto', 'vadd.base.c', '', 1)
runExp('base_par', '-qsmp=auto', 'vadd.base.c', '', 4)


runExp('essl_seq', '-qsmp=noauto -DESSL', 'vadd.blas.c',
       '-L/bgsys/ibm_essl/sles10/prod/opt/ibmmath/lib -lesslbg ' +
       '-L/opt/ibmcmp/xlf/bg/11.1/bglib -lxlf90_r -lxlfmath -lm',
       1)
runExp('essl_par', '-qsmp=auto -DESSL', 'vadd.blas.c',
       '-L/bgsys/ibm_essl/sles10/prod/opt/ibmmath/lib -lesslsmpbg ' +
       '-L/opt/ibmcmp/xlf/bg/11.1/bglib -lxlf90_r -lxlfmath -lm',
       4)


runExp('goto_seq', '-qsmp=noauto', 'vadd.blas.c',
       '-L/soft/apps/LIBGOTO -lgoto -L/opt/ibmcmp/xlf/bg/11.1/bglib -lxlf90_r ' +
       '-lpthread -lxlfmath -lm',
       1)
runExp('goto_par', '-qsmp=auto', 'vadd.blas.c',
       '-L/soft/apps/LIBGOTO -lgoto -L/opt/ibmcmp/xlf/bg/11.1/bglib -lxlf90_r ' +
       '-lpthread -lxlfmath -lm',
       4)


runExp('orio_seq', '-qsmp=omp:noauto -DORIO_SEQ', 'vadd.orio.c', '', 1)
runExp('orio_par', '-qsmp=omp:noauto -DORIO_PAR', 'vadd.orio.c', '', 4)
