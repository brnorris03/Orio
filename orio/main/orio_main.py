...
def start(argv, lang):
    ...
    import pragma_parser, ann_parser, cmd_line_opts, opt_driver
    ...
    for srcfile, out_filename in g.src_filenames.items():
        ...
        if not g.disable_orio:
            ...
            if pragma_parser.PragmaParser.leaderPragmaRE().search(src_code):
                src_code = pragma_parser.PragmaParser().parse(src_code)
