from orio.module.loop.submodule.submodule import SubModule
...
class Pragma(SubModule):
    ...
    def __init__(self, perf_params=None, transf_args=None, stmt=None, language='C'):
        super(Pragma, self).__init__(self, perf_params, transf_args, stmt, language)
    ...
    def readTransfArgs(self, perf_params, transf_args):
        ...
        for aname, rhs, line_no in transf_args:
            ...
            try:
                ...
                g.err(__name__+':%s: failed to evaluate the argument expression: %s\n --> %s: %s'
