...
Best performance cost: 
  [6.0699999999999997e-07, 2.84e-07, 2.4200000000000002e-07, 2.3900000000000001e-07, 2.4200000000000002e-07] 
Tuned for specific problem sizes: 
  N = 100000000 
Best performance parameters: 
  CFLAGS = -no-vec -xhost -restrict 
  PR = vector always 
--**/
...
/*@ Loops(transform Pragma(pragma_str=PR)) @*/
{
  ...
  for (i=0; i<8; i++ ) {
    ...
    double bm=(5.0-a6+bet*a9)*(xi/2.0);
