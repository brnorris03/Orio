...
% 
% 	 Verification for sparse triangular solve.
...
disp('Check Sparse Triangular solve.')
...
tic
[ rowPtr columnIndices values ] = getStructuredLowerTriangularCSR(n, nnz, distribution) ; 
toc
...
disp('spts time:'); 
tic
x = spts(b, n, rowPtr, columnIndices, values); 
toc
