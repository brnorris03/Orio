function [ rowPtr columnIndices values ] = getGeneralBandedCSR(n, nnz, distribution) 

% 	 Generates general sparse matrices with a banded structure.
...
% 
    ...
    for band = 0:9
        ...
        for j = 1:nnzThisBand
            ...
            % select whether to place above or below diagonal
            tempRand = rand(); 
            if(tempRand > .5)
                row(nnzSoFar) = rowInd; 
