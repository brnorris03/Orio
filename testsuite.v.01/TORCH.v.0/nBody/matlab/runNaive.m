function [ forceLog ] = runNaive(n, numSteps, forceType, output, saveFreq, verify) 
%
...
%
    ...
    for step = 1:numSteps
        ...
        for i = 1:n
            ...
            for j = 1:n
                if i ~= j
                    particles(i) = applyForce(particles(i), particles(j), cutoff, min_r, forceType); 
                end
            end
        end
