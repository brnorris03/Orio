...
\\
\vspace{-.05in}
{\small $^1$University of Colorado at Boulder Dept. of Computer Science, Boulder, CO~80302}\\
\vspace{-.05in}
...
\vspace{-.05in}
{\small $^4$University of Colorado at Boulder Dept. of Electrical and Computer Engineering, Boulder, CO~80302}\\
\vspace{-.05in}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\textwidth]{figures/refine-mv-dot.png}
...
\subsection{WAXPBY $v = Ax + By$}
perhaps add another term
...
% Placeholder for the new results, the loops tuned for the figure above were almost identical to the ones generated by the MATLAB compiler

\subsection{GESUMMV $y = a * (A * x) + b * (B * x)$}

\subsection{Bicgkernel}
