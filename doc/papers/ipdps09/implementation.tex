...
\end{minipage}
\\
%(a) Annotated AXPY-4 source code
%& 
%(b) Tuning specification for the Blue Gene/P\\
\end{tabular}
...
\end{minipage}
\\
%(a) Annotated code of matrix-matrix multiplication
%& 
%(b) Orio's parameter specifications\\
\end{tabular}
